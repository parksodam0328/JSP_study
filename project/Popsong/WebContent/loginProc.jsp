...
<center>
	...
	<table style="width:350px;">
		<tr>
			<td style="padding:20px 0 8px 0;" height="60px" align="center"><span id="song" style="font-weight:700;font-size:30px;"><a href="main.jsp">Popsong</a></span></td>
		</tr>
		<tr>
	...
	<div style="border:1px solid #ccc;margin:10px 35% 25% 35%;">
		<table>
		<tr>
			<td height="60px">계정이 없으신가요? <span id="word" style="color:#FA58AC;"><a href="join.jsp">가입하기</a></span></td>
		</tr>
	</table>
	</div>
	</center>
